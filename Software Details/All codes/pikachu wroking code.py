...
FRAME_FILE      = "/sd/pikachu.bin"
WAV_FILE        = "/sd/pikachu.wav"
...
try:
    ...
    if len(frames) == 0:
        raise Exception("No frames found in pikachu.bin")
    ...
    print("WAV open, playing Pikachu...")
